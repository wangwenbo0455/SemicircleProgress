...
@implementation CALayer (FastKit)
...
- (void)shakeLayer
{
    ...
    [self addAnimation:shake forKey:@"fastkit.shake"];
}
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"fastkit.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"fastkit.fade"];
}
...
- (void)removeShadow
{
    [self setShadowColor:[[UIColor clearColor] CGColor]];
    [self setShadowOpacity:0.0f];
